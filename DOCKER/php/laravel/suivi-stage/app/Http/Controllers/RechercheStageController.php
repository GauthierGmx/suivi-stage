    ...
    public function store(Request $request)
    {
        try
        {
            ...
            $uneRechercheStage = RechercheStage::create([
                ...
                'telephoneContact' => $donneesValidees['telephoneContact'],
                'adresseMailContact' => $donneesValidees['adresseMailContact'],
                'observations' => $donneesValidees['observations'],
                'dateRelance' => $donneesValidees['dateRelance'],
